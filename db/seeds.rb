...
10.times do
  products = ["tv", "vcr", "macbook", "macbook air", "mouse", "chair", "desk", "lamp", "water bottle"]
  Product.create(:name => products.sample, :price => Faker::Number.between(1,1500), :description => "this is a really long line of description for testing purposes is this 30 character yet????", :inventory => 0)
end
5.times do
